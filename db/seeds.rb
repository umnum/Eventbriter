...
event11.event_image.attach(io: File.open("/app/assets/images/event_image_1.jpg"),
...
event12 = Event.create!(name: 'Dave Chappelle Live in New York', location: '117 MacDougal St, New York, NY', 
    ...
    event12.event_image.attach(io: File.open("/app/assets/images/event_image_2.jpg"),
...
event13.event_image.attach(io: File.open("/app/assets/images/event_image_3.jpg"),
...
event14.event_image.attach(io: File.open("/app/assets/images/event_image_4.jpg"),
...
event21.event_image.attach(io: File.open("/app/assets/images/event_image_5.jpg"),
...
event22 = Event.create!(name: 'Halloween Party 2020 Monster Mash', location: '230 2nd St, Fall River, MA 02721', 
    ...
    start_sales_date: DateTime.new(2020, 10, 5, 12, 0, 0))
event22.event_image.attach(io: File.open("/app/assets/images/event_image_6.jpg"),
...
event23.event_image.attach(io: File.open("/app/assets/images/event_image_7.jpg"),
...
event24.event_image.attach(io: File.open("/app/assets/images/event_image_8.jpg"),
...
event31.event_image.attach(io: File.open("/app/assets/images/event_image_9.jpg"),
...
event32.event_image.attach(io: File.open("/app/assets/images/event_image_10.jpg"),
...
event33.event_image.attach(io: File.open("/app/assets/images/event_image_11.jpg"),
...
event34 = Event.create!(name: 'Billy Boy\'s Bar Mitzvah Bash', location: 'Billy Boy\'s house', 
    ...
    timezone: 'PDT', capacity: 100, status: 'Free')
event34.event_image.attach(io: File.open("/app/assets/images/event_image_12.jpg"),
...
event41.event_image.attach(io: File.open("/app/assets/images/event_image_13.jpg"),
...
event42.event_image.attach(io: File.open("/app/assets/images/event_image_14.jpg"),
...
event43.event_image.attach(io: File.open("/app/assets/images/event_image_15.jpg"),
...
event44 = Event.create!(name: 'The Slipnutz Comedy Reunion', location: 'Madison Square Garden', 
    ...
    start_sales_date: DateTime.new(2020, 11, 1, 12, 0, 0))
event44.event_image.attach(io: File.open("/app/assets/images/event_image_16.jpg"),
